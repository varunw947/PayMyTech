...
@Component({
  selector: 'app-operaor-update',
  templateUrl: './operaor-update.component.html',
  styleUrls: ['./operaor-update.component.css']
})
export class OperaorUpdateComponent implements OnInit {
