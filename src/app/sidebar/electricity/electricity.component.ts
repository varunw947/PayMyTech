...
export class ElectricityComponent implements OnInit {
 ...
 DistCommPert:any;
  ...
  ngOnInit(): void {
    ...
    this.exAPIService.getElectricityList().subscribe(categoryData => {
  ...
  fetchCommission(prid:any)
{
  ...
  this.accountService.getElectricityCommission(parseInt(prid))
  ...
  onSubmit() 
  {
    ...
    this.exAPIService.ElectricityBill(this.ProviderId, this.Amount, this.CustomerNumber, this.operatorType).subscribe
    (
      (f:any) =>
      {
            console.log(f);
            ...
            this.TransactionType = "Electricity Bill";
