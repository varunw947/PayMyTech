...
export class InsuranceComponent implements OnInit {
 ...
 Amount:any;
  ...
  ngOnInit(): void {
    ...
    this.exAPIService.getInsuranceList().subscribe(categoryData => {
  ...
  fetchCommission(prid:any)
  {
    ...
    this.accountService.getInsuranceCommission(parseInt(prid))
  ...
  onSubmit() 
  {
    ...
    this.exAPIService.InsuranceBill(this.ProviderId, this.Amount, this.CustomerNumber, this.MobileNumber, this.EmailID, this.operatorType).subscribe
    (
      (f:any) =>
      {
            console.log(f);
            ...
            this.TransactionType = "Insurance Bill";
