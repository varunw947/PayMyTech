...
export class DashboardService {
    ...
    GetSalesReportByDate(dateFrom:any,dateTo:any) {
      let obj ={DateFrom:dateFrom,DateTo:dateTo};
      //debugger;
      return this.CC.AVPostWithParamandreturn2('api/AdminDashboard', 'GetDashboardData',obj);
    }

    GetPieChartByDate(dateFrom:any,dateTo:any) {
        let obj ={DateFrom:dateFrom,DateTo:dateTo};
        debugger;
        return this.CC.AVPostWithParamandreturn2('api/AdminDashboard', 'GetPieChartData',obj);
      }
